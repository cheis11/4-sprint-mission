...
public class UserControllerTest {
  ...
  void createUser_success() throws Exception {
    ...
    UserCreateRequest request = new UserCreateRequest("kim", "kim@test.com", "pass123");
    ...
    MockMultipartFile jsonPart =
        new MockMultipartFile(
            "userCreateRequest", "", "application/json", om.writeValueAsBytes(request));
  ...
  //                .accept(MediaType.APPLICATION_JSON)
  //        )
  //        .andExpect(status().isBadRequest()); // @Valid 에서 막힘
  //  }
  ...
  //    UserStatusUpdateRequest badRequest = new UserStatusUpdateRequest(null);
  //    String body = om.writeValueAsString(badRequest);
  //
  //    // when & then
  //    mockMvc.perform(
  ...
  //                .accept(MediaType.APPLICATION_JSON)
  //        )
  //        .andExpect(status().isBadRequest()); // @NotNull 위반
  //  }
