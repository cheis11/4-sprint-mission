...
public class DiscodeitAuthorityUtils {
  ...
  private final List<GrantedAuthority> ADMIN_ROLES = AuthorityUtils.createAuthorityList("ROLE_ADMIN", "ROLE_CHANNEL_MANAGER", "ROLE_USER");
  private final List<GrantedAuthority> CHANNEL_MANAGER_ROLES = AuthorityUtils.createAuthorityList("ROLE_CHANNEL_MANAGER" , "ROLE_USER");
